-- BigBasket Capstone - Part 1 Task 5
...
-- (b) Fixed monthly-by-category business report used to create monthly_category_revenue.csv.
-- Revenue and average revenue are for Delivered orders only.
SELECT
...
-- (c) Category targets and variance diagnostics.
...
SELECT
    ...
    CASE
        ...
        WHEN cr.total_revenue >= ct.target_revenue_inr * 0.85 THEN 'Below Target - Watch'
